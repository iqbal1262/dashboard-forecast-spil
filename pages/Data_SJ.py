...
def display_SJ_alat_berat():
    ...
    st.write("Konten dan analisis untuk SJ Deck akan segera tersedia di sini.")
...
if pilihan_SJ == "SJ Kapal":
    ...
    display_SJ_alat_berat()  # Panggil fungsi untuk halaman dummy